    ...
    <div class="flex flex-col min-h-[calc(100vh-100px)] justify-between mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div class="flex flex-col items-start w-full space-y-2">
            <textarea
                ...
                @enderror dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm"
            >
            </textarea>
            @error('question')
